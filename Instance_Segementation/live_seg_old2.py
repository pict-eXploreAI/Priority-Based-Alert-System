...
from Instance_Segementation.mmrcnn import visualize2
...
def run_instance_model(model,frame):
    ...
    r = results[0]
    print(r['class_ids'])
    frame = visualize2.display_instances_live(frame, r['rois'], r['masks'], r['class_ids'], 
...
if __name__ == "__main__":
    ...
    cap = cv2.VideoCapture('../VideoTest/trim.mov')
